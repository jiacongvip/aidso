...
export const ApiDocPage = () => {
  return (
    <div className="flex-1 flex max-w-7xl mx-auto w-full pt-20 px-6 gap-8 pb-20">
      {/* Sidebar */}
      <div className="w-64 hidden md:block sticky top-24 h-[calc(100vh-100px)]">
        ...
        <ul className="space-y-1">
          {['Introduction', 'Authentication', 'Rate Limits', 'Errors'].map((item) => (
            <li
              key={item}
              className="px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-100 cursor-pointer"
            >
              {item}
            </li>
          ))}
        ...
        <ul className="space-y-1">
          <li className="px-3 py-2 text-sm font-medium text-brand-purple bg-purple-50 rounded-lg cursor-pointer">
            POST /v1/search
          </li>
          <li className="px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-100 cursor-pointer">
            GET /v1/analysis
          </li>
          <li className="px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-100 cursor-pointer">
            GET /v1/trends
      ...
      <div className="flex-1">
        <div className="mb-10">
          ...
          <p className="text-gray-600 leading-relaxed">
            Perform a real-time GEO search across multiple AI engines including DeepSeek, Doubao, and WeChat. This
            endpoint returns aggregated results, DOM snapshots, and reasoning traces.
          </p>
        </div>
